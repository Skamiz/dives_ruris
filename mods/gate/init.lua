...
local function can_place(pos, n0)
	...
	if n1 and n1.name == "default:fence_wood" and n2 and
		...
		return false
	elseif n1 and n1.name == "default:fence_wood_black" and n2 and 
			n2.name == "default:fence_wood_black" then
		return false
	elseif n1 and n1.name == "default:fence_wood_blue" and n2 and 
			n2.name == "default:fence_wood_blue" then
		return false
	elseif n1 and n1.name == "default:fence_wood_brown" and n2 and 
			n2.name == "default:fence_wood_brown" then
		return false
	elseif n1 and n1.name == "default:fence_wood_cyan" and n2 and 
			n2.name == "default:fence_wood_cyan" then
		return false
	elseif n1 and n1.name == "default:fence_wood_dark_green" and n2 and 
			n2.name == "default:fence_wood_dark_green" then
		return false
	elseif n1 and n1.name == "default:fence_wood_dark_grey" and n2 and 
			n2.name == "default:fence_wood_dark_grey" then
		return false
	elseif n1 and n1.name == "default:fence_wood_green" and n2 and 
			n2.name == "default:fence_wood_green" then
		return false
	elseif n1 and n1.name == "default:fence_wood_grey" and n2 and 
			n2.name == "default:fence_wood_grey" then
		return false
	elseif n1 and n1.name == "default:fence_wood_magenta" and n2 and 
			n2.name == "default:fence_wood_magenta" then
		return false
	elseif n1 and n1.name == "default:fence_wood_orange" and n2 and 
			n2.name == "default:fence_wood_orange" then
		return false
	elseif n1 and n1.name == "default:fence_wood_pink" and n2 and 
			n2.name == "default:fence_wood_pink" then
		return false
	elseif n1 and n1.name == "default:fence_wood_red" and n2 and 
			n2.name == "default:fence_wood_red" then
		return false
	elseif n1 and n1.name == "default:fence_wood_violet" and n2 and 
			n2.name == "default:fence_wood_violet" then
		return false
	elseif n1 and n1.name == "default:fence_wood_white" and n2 and 
			n2.name == "default:fence_wood_white" then
		return false
	elseif n1 and n1.name == "default:fence_wood_yellow" and n2 and 
			n2.name == "default:fence_wood_yellow" then
		return false
	end
