...
if ARMOR_MATERIALS.steel then
	minetest.register_tool("shields:shield_steel", {
		...
		groups = {armor_shield=10, armor_heal=1, armor_use=500},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.bronze then
	minetest.register_tool("shields:shield_bronze", {
		...
		groups = {armor_shield=10, armor_heal=3, armor_use=250},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.diamond then
	minetest.register_tool("shields:shield_diamond", {
		...
		groups = {armor_shield=15, armor_heal=6, armor_use=100},
		wear = 0,
	})
end
...
if ARMOR_MATERIALS.nyan then
	minetest.register_tool("shields:shield_nyan", {
		description = "Nyan Shield",
		inventory_image = "shields_inv_shield_nyan.png",
		groups = {armor_shield=18, armor_heal=12, armor_use=25},
		wear = 0,
	})
end
