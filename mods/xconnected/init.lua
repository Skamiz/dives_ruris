...
xconnected.register_wall( 'xconnected:wall_desert_cobble',      'default_desert_cobble.png' );
...
minetest.register_craft({
	output = 'xconnected:wall_cobble_c4 8',
	recipe = {
...
minetest.register_craft({
	output = 'xconnected:wall_mossycobble_c4 8',
	recipe = {
...
minetest.register_craft({
	output = 'xconnected:wall_desert_cobble_c4 8',
	recipe = {
