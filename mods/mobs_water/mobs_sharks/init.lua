...
-- large
	if ENABLE_SHARK_LARGE then
		...
		mobs:spawn_specific("mobs_sharks:shark_lg", l_spawn_in, l_spawn_near, -1, 20, 3000, l_spawn_chance, 1, -10, -5)
...
-- medium
	if ENABLE_SHARK_MEDIUM then
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		mobs:spawn_specific("mobs_sharks:shark_md", l_spawn_in, l_spawn_near, -1, 20, 3000, l_spawn_chance, 1, -10, -5)
...
-- small
	if ENABLE_SHARK_SMALL then
		...
		--name, nodes, neighbours, minlight, maxlight, interval, chance, active_object_count, min_height, max_height
		mobs:spawn_specific("mobs_sharks:shark_sm", l_spawn_in, l_spawn_near, -1, 20, 3000, l_spawn_chance, 1, -10, -5)
