...
-- add some new nodes and disable some originalnodes
...
-- replacement
 ...
 --nodes  
	...
	-- Deco Home
	    ...
	    tiles = {
				"forniture_cabinet_side.png",
				"forniture_cabinet_side.png",
				"forniture_cabinet_side.png",
				"forniture_cabinet_side.png",
				"forniture_cabinet_side.png",
				"forniture_cabinet_front.png",
			},
		paramtype = 'light',
		paramtype2 = "facedir",
		...
		minetest.register_node("3dforniture:armchair",
			{ description = 'Black Armchair (base)',
			tiles = {
