...
minetest.register_node("default:chest", {
	...
	paramtype2 = "facedir",
	groups = {choppy=2,oddly_breakable_by_hand=2, chests=1, storage = 1},
...
minetest.register_node("default:chest_locked", {
	...
	paramtype2 = "facedir",
	groups = {choppy=2,oddly_breakable_by_hand=2, lchests=1, storage = 1},
	legacy_facedir_simple = true,
	is_ground_content = false,
	sounds = default.node_sound_wood_defaults(),
...
-- already exists in the cart mod
