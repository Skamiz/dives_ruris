...
minetest.register_craftitem("default:hardened_leather", {
	description = "Hardened Leather",
	inventory_image = "default_hardened_leather.png",
})
...
minetest.register_craftitem("default:topaz", {
	description = "Topaz",
	inventory_image = "default_topaz.png",
})
...
minetest.register_craftitem("default:amethyst", {
	...
	inventory_image = "default_amethyst.png",
})
