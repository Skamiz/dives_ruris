...
-- default settings
 -- statbar positions
HUD_HEALTH_POS = {x=0,y=0.9}
HUD_HEALTH_OFFSET = {x=5,y=-15}
HUD_HUNGER_POS = {x=1,y=0.9}
HUD_HUNGER_OFFSET = {x=-325,y=-15}--y 30
HUD_AIR_POS = {x=0.5,y=0.9} --y1
HUD_AIR_OFFSET = {x=-80,y=-75} --x15
HUD_ARMOR_POS = {x=0.5,y=0.9}
HUD_ARMOR_OFFSET = {x=-80, y=-7} -- x175
